    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-[#B6BAC3] mb-1">Content *</label>
                    <textarea value={formData.content || ""} onChange={(e) => setFormData({ ...formData, content: e.target.value })} rows={3} className="w-full bg-[#434D64] border border-[#434D64] text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#C9A94D] focus:border-transparent" required />
                </div>
