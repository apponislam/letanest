...
//                                 <textarea value={formData.content} onChange={(e) => setFormData({ ...formData, content: e.target.value })} rows={3} className="w-full bg-[#434D64] border border-[#434D64] text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#C9A94D] h-40 md:h-96 focus:border-transparent placeholder-[#B6BAC3]" placeholder="Message content..." required />
//                             </div>
//                         </div>
...
//                                         <EditForm template={template} onSave={(data) => handleUpdate(template._id, data)} onCancel={() => setEditingId(null)} isLoading={isUpdatingLoading} />
//                                     ) : (
...
//                                                 </div>
//                                                 <p className="text-white bg-[#434D64] p-3 rounded-lg border border-[#434D64] mb-2">{template.content}</p>
...
// // Edit Form Component
// const EditForm = ({ template, onSave, onCancel, isLoading }: { template: IMessageType; onSave: (data: UpdateMessageTypeDto) => void; onCancel: () => void; isLoading: boolean }) => {
...
//                 <div className="md:col-span-2">
//                     <label className="block text-sm font-medium text-[#B6BAC3] mb-1">Content *</label>
//                     <textarea value={formData.content || ""} onChange={(e) => setFormData({ ...formData, content: e.target.value })} rows={3} className="w-full bg-[#434D64] border border-[#434D64] text-white rounded-lg px-3 h-40 md:h-96 py-2 focus:outline-none focus:ring-2 focus:ring-[#C9A94D] focus:border-transparent" required />
//                 </div>
