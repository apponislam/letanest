                ...
                <>
                    <div className="space-y-3">
                        {properties.map((property: any) => (
                            <div key={property._id} className="p-4 rounded-[12px] flex justify-between items-center border border-[#C9A94D] flex-col md:flex-row">
                                ...
                                {/* Action Buttons */}
                                <div className="w-full md:w-auto flex flex-col gap-2 justify-end mt-3 md:mt-0">
                                    <Link href={`/dashboard/property-listing/edit/${property._id}`} className="w-full md:w-auto md:ml-4">
                                        <button className="w-full p-2 rounded-[10px] bg-[#C9A94D] hover:bg-[#C9A94D] transition flex items-center justify-center gap-1 text-white">
                                            <Edit className="w-5 h-5" />
                                            <span>Edit</span>
                                        </button>
                                    </Link>
                                    <button onClick={() => onDeleteClick(property)} className="p-2 rounded-[10px] bg-red-600 hover:bg-red-700 transition md:ml-4 flex items-center justify-center gap-1 text-white w-full md:w-auto">
                    ...
                    {totalPages > 1 && (
                        <div className="flex justify-between items-center mt-6 pt-4 border-t border-[#C9A94D] flex-col md:flex-row gap-4">
                            <button onClick={onPrevPage} disabled={currentPage === 1} className="flex items-center gap-2 px-4 py-2 bg-[#434D64] text-white rounded-[8px] hover:bg-[#535a6b] disabled:opacity-50 disabled:cursor-not-allowed transition">
                                Previous
                            </button>
                            ...
                            <button onClick={onNextPage} disabled={currentPage >= totalPages} className="flex items-center gap-2 px-4 py-2 bg-[#434D64] text-white rounded-[8px] hover:bg-[#535a6b] disabled:opacity-50 disabled:cursor-not-allowed transition">
                                Next
                            </button>
                        </div>
                    )}
