...
// const PropertyList = ({ properties, isLoading, filters, meta, title, onSearch, onStatusFilter, onClearFilters, onPrevPage, onNextPage, onDeleteClick, showStatusFilter, getStatusColor, formatDate }: any) => {
...
//                                         </button>
//                                     </Link>
//                                     <button onClick={() => onDeleteClick(property)} className="p-2 rounded-[10px] bg-red-600 hover:bg-red-700 transition md:ml-4 flex items-center justify-center gap-1 text-white">
