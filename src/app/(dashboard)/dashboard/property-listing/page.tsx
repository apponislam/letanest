                            ...
                            <div key={property._id} className="p-4 rounded-[12px] flex justify-between items-center border border-[#C9A94D] flex-col md:flex-row">
                                ...
                                <div className="w-full md:w-auto flex flex-col gap-2 justify-end mt-3 md:mt-0">
                                    ...
                                    {canDeleteProperty(property) ? (
                                        ...
                                        <button disabled className="p-2 rounded-[10px] bg-gray-600 cursor-not-allowed transition md:ml-4 flex items-center gap-1 text-gray-400 justify-center" title="Cannot delete published properties">
                                            <Trash2 className="w-5 h-5" />
                                            <span>Delete</span>
                                        </button>
                                    )}
