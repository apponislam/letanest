...
//     const extraFeePaid = messageData?.data?.extraFeePaid === true;
...
//         } else {
//             return agreedFee + (enabled && !extraFeePaid ? peaceOfMindFee : 0);
//         }
//     }, [agreedFee, bookingFee, enabled, isBookingFeePaid, extraFeePaid, peaceOfMindFee]);
...
//                     agreedFee,
//                     bookingFee,
//                     extraFee: enabled && !extraFeePaid ? peaceOfMindFee : 0,
//                     totalAmount: total,
//                     propertyId: property._id,
//                     conversationId: messageData.data.conversationId,
//                     messageId: messageData.data._id,
...
//                         {/* ALWAYS SHOW PEACE OF MIND SECTION */}
//                         <div className=" bg-[#2D3546] mb-6 p-[10px] rounded-[8px]">
//                             <div className={`flex md:items-center justify-between flex-col md:flex-row gap-3 ${enabled ? "mb-8" : "mb-0"}`}>
...
//                                         // REMOVED disabled prop - users can toggle anytime
//                                     />
//                                 </div>
//                             </div>
//                             {enabled && (
//                                 <div className={`flex rounded-[8px] px-5 py-2 gap-5 flex-col md:flex-row ${extraFeePaid ? "bg-green-900 text-green-300" : "bg-[#626A7D] text-black"}`}>
//                                     <Image alt="Property id" src="/listing/pay/shield.png" height={24} width={24}></Image>
//                                     <p>{extraFeePaid ? "Peace of Mind Guarantee already paid" : "Peace of Mind Guarantee added to your booking"}</p>
//                                 </div>
//                             )}
//                         </div>
...
const ListingPayment = () => {
    ...
    // Only show peace of mind section for booking fee payment
    const shouldShowPeaceOfMind = !isBookingFeePaid;
    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            if (!isBookingFeePaid) {
                ...
                // COMMISSION PAYMENT - No peace of mind option here
                console.log("Processing commission based payment...");
                const paymentResponse = await createPayment({
                    agreedFee,
                    bookingFee,
                    extraFee: 0, // No peace of mind fee for commission payment
                    totalAmount: total,
                    propertyId: property._id,
                    conversationId: messageData.data.conversationId,
                    messageId: messageData.data._id,
                    ...
                    <div className="text-[#C9A94D]">
                            ...
                            <div className="bg-[#2D3546] py-3 md:py-5 px-4 md:px-14 rounded-[12px]">
                                ...
                                <div className="flex flex-col gap-2 font-bold text-[18px]">
                                    ...
                                    {!isBookingFeePaid ? (
                                        ...
                                        // COMMISSION BASED VIEW (Booking fee already paid) - NO PEACE OF MIND
                                        <>
                                            <div className="flex items-center justify-between text-green-400">
                                                <h1>Booking Fee</h1>
                                                <h1>✓ Paid</h1>
                        ...
                        {shouldShowPeaceOfMind && (
                            <div className=" bg-[#2D3546] mb-6 p-[10px] rounded-[8px]">
                                ...
                                {enabled && (
                                    <div className="flex rounded-[8px] px-5 py-2 gap-5 flex-col md:flex-row bg-[#626A7D] text-black">
                                        <Image alt="Property id" src="/listing/pay/shield.png" height={24} width={24}></Image>
                                        <p>Peace of Mind Guarantee added to your booking</p>
                                    </div>
                                )}
                            </div>
                        )}
