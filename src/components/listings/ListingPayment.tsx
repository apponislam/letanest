...
const ListingPayment = () => {
    ...
    const agreedFee = messageData?.data?.agreedFee ? Number(messageData.data.agreedFee) : 0;
    const bookingFee = messageData?.data?.bookingFee ? Number(messageData.data.bookingFee) : 0;
