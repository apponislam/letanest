...
const BookingCards = () => {
    ...
    const cards = [
        ...
        },
        {
            ...
            link: "/dashboard/listing/add",
            showCondition: !user || user?.role !== "GUEST",
        },
    ];
    ...
    return (
        <div className="container mx-auto">
            <div className="flex flex-col gap-6 mx-4 md:mx-0">
                {cards.map((card, idx) => {
                    // Skip rendering if card has showCondition and it's false
                    if (card.showCondition === false) return null;
