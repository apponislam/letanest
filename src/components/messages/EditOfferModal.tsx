            ...
            <div className="bg-white rounded-lg w-full max-w-md shadow-xl">
                ...
                <div className="p-4">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* Price Input */}
                        <div className="space-y-2">
                            <label className="block text-sm font-medium text-[#14213D]">New Bespoke Offer Price</label>
                        ...
                        <div className="bg-[#C9A94D]/10 border border-[#C9A94D] rounded-lg p-3">
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-medium text-[#14213D]">New Bespoke Offer Price</span>
