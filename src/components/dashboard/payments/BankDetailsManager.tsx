...
// import { CheckCircle, XCircle, CreditCard, Plus, Edit, Trash2, X, Building, User, Globe } from "lucide-react";
...
//     // API Hooks
//     const { data: bankDetailsResponse, refetch: refetchBankDetails } = useGetMyBankDetailsQuery();
...
//                 <div className={`p-2 rounded-full ${hasBankDetails ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"}`}>{hasBankDetails ? <CheckCircle className="w-4 h-4" /> : <XCircle className="w-4 h-4" />}</div>
//                 <div className="text-left">
//                     <div className="font-semibold">Bank Details</div>
//                     <div className={`text-xs ${hasBankDetails ? "text-green-600" : "text-red-600"}`}>{hasBankDetails ? "✓ Bank Details Added" : "✗ No Bank Details"}</div>
//                 </div>
//             </button>
...
"use client";
import { useState, useEffect } from "react";
import { CheckCircle, XCircle, CreditCard, Plus, Edit, Trash2, X, Building, User, Globe, Hash, GlobeIcon, Key } from "lucide-react";
import { useCreateBankDetailsMutation, useGetMyBankDetailsQuery, useUpdateMyBankDetailsMutation, useDeleteMyBankDetailsMutation } from "@/redux/features/bankdetails/bankDetailsApi";
import { toast } from "sonner";
