...
// const ReviewContent = ({ reviews, isLoading, activeTab, openRow, setOpenRow, formatDate, getPropertyName, getRatingCategories, getStatusBadge, handleAction, currentPage, totalPages, totalItems, onPageChange }: any) => {
//     return (
