// "use client";
// import { useGetHostPaymentsQuery, useGetHostSingleInvoicePDFMutation } from "@/redux/features/propertyPayment/propertyPaymentApi";
...
//     // const [getHostSingleInvoicePDF] = useGetHostSingleInvoicePDFMutation();
...
//                                         </div>
//                                         <div>
//                                             <button className="bg-[#C9A94D] text-white px-2 py-1" onClick={() => handleDownloadInvoice(payment._id)} disabled={generateLoading}>
