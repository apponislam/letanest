...
export const baseApi = createApi({
    ...
    tagTypes: ["User", "Terms", "Users", "Properties", "Verifications", "Subscriptions", "SubscribedPlans", "MySubscriptions", "Conversations", "Messages", "PaymentMethods", "StripeAccount", "propertyPayments", "Dashboard", "Rating", "Contacts", "MyProfile", "PageConfig", "MyRatings"],
    endpoints: () => ({}),
});
